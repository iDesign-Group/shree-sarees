...
const sendOrderConfirmation = async (toEmail, order, items) => {
    ...
    <div style="font-family:'Inter',Arial,sans-serif;max-width:600px;margin:0 auto;background:#FAF7F2;padding:24px;">
      ...
      <div style="background:#FFFFFF;padding:24px;border-radius:0 0 8px 8px;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        ...
        <table style="width:100%;border-collapse:collapse;margin:16px 0;">
          <thead>
            <tr style="background:#FAF7F2;">
              ...
              <th style="padding:8px 12px;text-align:center;color:#6D1C2E;font-size:13px;">Sarees</th>
              <th style="padding:8px 12px;text-align:right;color:#6D1C2E;font-size:13px;">Amount</th>
            </tr>
          </thead>
        ...
        <div style="border-top:2px solid #C9A84C;padding-top:12px;margin-top:8px;">
          ...
          <p style="margin:4px 0;font-size:18px;"><strong>Total Amount: ₹${Number(order.total_amount).toLocaleString('en-IN')}</strong></p>
        </div>
        <p style="color:#6B6B6B;font-size:13px;margin-top:16px;">Payment due within 60 days.</p>
      </div>
      <p style="text-align:center;color:#6B6B6B;font-size:11px;margin-top:16px;">© Shree Sarees. All rights reserved.</p>
    </div>
  `;
